...
fin = open('../trade-dst/utils/mapping.pair','r')
replacements = []
...
def divideData(data):
    ...
    with open(args.data_dir + '/dev_dials.json', 'w') as f:
        json.dump(val_dials, f, indent=4)

    with open(args.data_dir + '/test_dials.json', 'w') as f:
        json.dump(test_dials, f, indent=4)

    with open(args.data_dir + '/train_dials.json', 'w') as f:
